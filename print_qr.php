...
<head>
    ...
    <style>
        ...
        @media print { .no-print { display: none !important; } @page { margin: 0; size: portrait; } body { background: white !important; } }
        body { background: #f0f2f5; font-family: 'Inter', sans-serif; display: flex; flex-direction: column; align-items: center; padding: 20px; }
        .qr-container { display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; background: white; padding: 30px; border-radius: 12px; }
        .qr-item { border: 1px solid #ddd; padding: 20px; width: 280px; text-align: center; border-radius: 8px; }
        .qr-title { font-size: 1.8rem; font-weight: 800; margin-bottom: 15px; }
        .info-row { font-size: 1rem; margin-bottom: 5px; text-align: left; }
        .qr-image { width: 160px; height: 160px; margin-top: 15px; }
        .btn-print { position: fixed; top: 20px; right: 20px; padding: 12px 24px; background: #2563eb; color: white; border: none; border-radius: 30px; font-weight: 700; cursor: pointer; }
    </style>
</head>
<body>
