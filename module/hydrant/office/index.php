...
<div class="page-inner">
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Hydrant Management - Office</h3>
        </div>
        <div class="ms-md-auto py-2 py-md-0 d-flex gap-2">
            ...
            <a href="?page=hydrant-create&area=Office" class="btn btn-primary btn-round">
...
<script>
    $(document).ready(function () {
        ...
        $('#hydrant-container').on('click', '.btn-print-qr', function (e) {
            e.stopPropagation();
        ...
        $('#hydrant-container').on('click', '.status-toggle-btn', function (e) {
            e.stopPropagation();
            const btn = $(this);
                ...
                if (willUpdate) {
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.success) {
                                const card = btn.closest('.hydrant-card');
                                if (newStatus == 0) {
        ...
        function createCardHtml(item) {
            ...
            return `
                <div class="hydrant-card ${inactiveClass}" data-id="${item.id}">
                    <input type="checkbox" class="card-checkbox item-checkbox">
        ...
        function loadMore() {
            ...
            $.ajax({
                url: 'actions/office/ac_get_data_hydrant.php',
                type: 'GET',
