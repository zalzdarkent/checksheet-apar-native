            ...
            <div class="card card-wizard">
                <div class="card-header pb-0">
                    ...
                    <div class="progress mt-3" style="height: 4px;">
                        <div id="wizard-progress" class="progress-bar bg-primary" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="code" id="input-code" class="form-control" placeholder="Pilih area..." required readonly>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold">Lokasi Spesifik</label>
                                            <input type="text" name="location" class="form-control" placeholder="Contoh: Belakang Gedung B" required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="pic_empid" id="input-pic" class="form-select select2" required>
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="map-picker-wrapper border rounded bg-light p-2 position-relative" style="min-height: 450px; overflow: auto; max-height: 600px;">
                                        <div id="map-picker-container" class="position-relative mx-auto" style="cursor: crosshair;">
                                            ...
                                            <div id="marker-picker" class="d-none animate__animated animate__bounceIn">
                                                <i class="fas fa-map-marker-alt text-danger" style="font-size: 24px; position: absolute; transform: translate(-50%, -100%);"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="wizard-content" id="step-2-content" style="display: none;">
                        <div class="card-body">
                            <div class="alert alert-warning mb-4">
                                ...
                                <strong>Penting:</strong> Harap lakukan pengecekan kondisi fisik Hydrant sebelum disimpan ke sistem.
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea name="general_notes" class="form-control" rows="1" placeholder="Opsional..."></textarea>
                                </div>
                            </div>
