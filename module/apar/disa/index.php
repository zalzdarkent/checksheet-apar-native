<?php
$area = 'Disa';
include(__DIR__ . '/../../../actions/disa/ac_get_data_apar.php');
...
<div class="page-inner">
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">APAR Management - Disa</h3>
        </div>
        <div class="ms-md-auto py-2 py-md-0 d-flex gap-2">
            ...
            <a href="?page=apar-create&area=Disa" class="btn btn-primary btn-round">
...
<script>
    $(document).ready(function () {
        ...
        function loadMore() {
            ...
            $.ajax({
                url: 'actions/disa/ac_get_data_apar.php',
                type: 'GET',
