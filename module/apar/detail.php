...
<div class="page-inner">
    ...
    <div class="detail-card">
        ...
        <button type="button" class="btn btn-inspeksi bg-warning text-dark border-0 m-0 mb-4" id="btn-scan-qr" style="cursor:pointer; display:inline-block; margin-bottom: 25px !important;">
