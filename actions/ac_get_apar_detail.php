...
if ($id <= 0) {
    ...
    if ($apar) {
        ...
        $sql_cases = "SELECT c.*, ISNULL(e_pic.EmployeeName, u_pic.REALNAME) as pic_name, u_ver.name as verified_by_name
                      ...
                      LEFT JOIN [apar].[dbo].[users] u_ver ON c.verified_by = u_ver.id
                      WHERE c.apar_id = ? 
